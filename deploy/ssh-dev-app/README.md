...
GStreamer, import GstBase/GstVideo, register the recorder-owned
`dashcamnv12overlay` transform, and discover it together with the `queue`,
`libcamerasrc`, `v4l2h264enc`, `alsasrc`, `audioconvert`, `audioresample`,
`voaacenc`, and `aacparse` factories. The
